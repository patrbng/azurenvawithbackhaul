...
resource "azurerm_virtual_network_peering" "spoke2-outbound-peer" {
  name                      = "spoke2-outbound-peer"
  resource_group_name       = azurerm_resource_group.spoke2-vnet-rg.name
  virtual_network_name      = azurerm_virtual_network.spoke2-vnet.name
...
resource "azurerm_virtual_network_peering" "outbound-spoke2-peer" {
  name                      = "outbound-spoke2-peer"
